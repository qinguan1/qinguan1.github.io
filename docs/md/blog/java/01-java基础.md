...
#### 六、说明一下public static void main(String args[])这段声明里每个关键字的作用
...
#### 十一、char型变量中能不能存储一个中文汉字?为什么？

可以。Java默认Unicode编码。Unicode码占16位。 char两个字节刚好16位。

#### 十二、public，private，protected的区别，继承方法与访问权限
...
#### 十四、**short s1 = 1; s1 = s1 + 1;有错吗？short s1 = 1; s1 += 1;有错吗？**
...
#### 十八、Java中final、finally、finalize的区别与用法
...
#### 二十一、Java 中操作字符串都有哪些类？它们之间有什么区别？
...
#### 二十二、String str="a"与 String str=new String("a")一样吗？

不一样，因为内存的分配方式不一样。

String str="a"; -> 常量池      String str=new String("a") -> 堆内存

#### 二十三、**抽象类能使用 final 修饰吗？**
...
#### 二十五、重载（Overload）和重写（Override）的区别。重载的方法能否根据返回类型进行区分？
...
#### 二十七、**Java 中Comparator 与Comparable 有什么不同？**
...
#### 四十七、break ,continue ,return 的区别及作用
...
#### 四十九、在Java中定义一个不做事且没有参数的构造方法的作用

Java程序在执行子类的构造方法之前，如果没有用super()来调用父类特定的构造方法，则会调用父类中“没有参数的构造方法”。因此，如果父类中只定义了有参数的构造方法，而在子类的构造方法中又没有用super()来调用父类中特定的构造方法，则编译时将发生错误，因为Java程序在父类中找不到没有参数的构造方法可供执行。解决办法是在父类里加上一个不做事且没有参数的构造方法。

#### 五十、在调用子类构造方法之前会先调用父类没有参数的构造方法，其目的是？

帮助子类做初始化工作。

#### 五十一、一个类的构造方法的作用是什么？若一个类没有声明构造方法，改程序能正确执行吗？为什么？
